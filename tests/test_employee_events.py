...
def test_db_exists(db_path):    
    ...
    assert db_path.is_file(), "Database path not found" 
...
def test_employee_table_exists(table_names):
    ...
    assert 'employee' in table_names, print("employee not in table_names list")
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'team' in table_names, "team not in table_names list"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    #### YOUR CODE HERE
    assert 'employee_events' in table_names, "employee_events not in table_names list"
